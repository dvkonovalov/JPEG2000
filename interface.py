...
show_image_jpeg2000 = tk.Button(window, text='Посмотреть изображение', activebackground='red', font='Times 16',
                                background='#00A600', command=show_image)
...
show_image_jpeg2000 = tk.Button(window, text='Конвертировать в JPG', activebackground='red', font='Times 16',
                                background='#00A600', command=convert_image)
